...
class _BerandaPageState extends State<BerandaPage> {
          ...
          child: new ListView(
            ...
            children: <Widget>[
              ...
              new Container(
                ...
                child: new Column(
                  children: <Widget>[_buildGoFoodFeatured(), _buildPromo()],
                ),
              )
            ],
          ),
  ...
  Future<List<Food>> fetchFood() async {
    ...
    _goFoodFeaturedList
        .add(new Food(title: "Steak Andakar", image: "assets/image/food1.jpg"));
    _goFoodFeaturedList.add(
        new Food(title: "Mie Ayam Tumini", image: "assets/image/food2.jpg"));
    _goFoodFeaturedList.add(
        new Food(title: "Tengkleng Hohah", image: "assets/image/food3.jpg"));
    _goFoodFeaturedList
        .add(new Food(title: "Warung Steak", image: "assets/image/food4.jpg"));
    _goFoodFeaturedList.add(new Food(
        title: "Kindai Warung Banjar", image: "assets/image/food5.jpg"));
  ...
  Future<List<Promo>> fetchPromo() async {
    ...
    _poromoList.add(new Promo(
        image: "assets/image/promo_1.jpg",
    ...
    _poromoList.add(new Promo(
        ...
        button: "CARI TAU!"));
    _poromoList.add(new Promo(
        image: "assets/image/promo_4.jpg",
